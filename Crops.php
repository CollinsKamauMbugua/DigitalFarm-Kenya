    ...
    <div class="blog-body">
      ...
      <div  class="category-content" style="padding: 0px 10px 10px 10px;">
        <center>
          ...
          <br><br><span  style="color: green; font-weight: bold; ">5) What harvest can you expect:</span><br><br> <img src="./img/plant5.jpg" class="img-style" style='width:300px; height:150px;'><br> The amount of maize that can be harvested (per hectare) depends on the variety you planted, amount of rainfall, sunshine and the level of weed, pest and disease control management that was applied. Although Africa has some of the lowest maize yields in the world, it is not uncommon to expect between 2,000 to 4,000 kilograms per hectare. </p>
            <h4>conditions</h4>
        ...
        <center>
          ...
          <div class="panel-accordion">
            ...
            <p>Legumes come in different types: beans, peas, groundnuts e.t.c <br><br> <img src="./img/legums.jpg" class="img-style" style='width:300px; height:150px;'><br>To venture into legume farming one mmust have a well defined roadmap for the excellence in the business. Apart from the large export market for the same, there is a good local market of mostly beans. </p>
            <h4>Market</h4>
        ...
        <center>
          ...
          <div class="panel-accordion">
            ...
            <img src="./img/tuber.jpg" class="img-style" style='width:300px; height:150px;'>
            <ul class="link">
              <label>Also see...</label>
        ...
        <center>
          ...
          <div class="panel-accordion">
            ...
            <img src="./img/vegetimg.jpeg" class="img-style" style='width:300px; height:150px;'>
