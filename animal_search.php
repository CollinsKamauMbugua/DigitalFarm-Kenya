  ...
  <body>
    ...
    <div class="br-modal">
      <div class="breadcramps">
        ...
        <a href="animalpost.php">Animal Section</a>
        <a href="#" class="active">Animal Search Results</a>
      </div>
    </div><br><br>
...
if (isset($_POST['search'])) {
  ...
  $search_query = mysqli_query($con, "SELECT * FROM animals_pane WHERE title LIKE '%$seach_field%' OR author LIKE '%$seach_field%' OR description LIKE '%$seach_field%' ");
      ...
      $par_code = $row['code'];
        echo "
                <div style='margin-bottom: 10px; background:#eee; padding:10px;'>
                  ...
                  <p>On ".$row['title']."</p>
                  <p>".$row['description']."</p>
                  <img width=200 height=100 src='uploads/".$row['pic_upload']."'>
                </div>
              ";
    }
  }
