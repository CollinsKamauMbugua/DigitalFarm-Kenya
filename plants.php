...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Plants Docket | DigitalFarm Kenya</title>
  </head>
  <body>
    <header>
      <div class="logo">
    ...
    <section id="container"  style="margin-bottom: 3%;">
      <div class="tile">
        <a href="Crops.php"> <button><img src="./img/maize.jpg" alt=""><p>Crops</p></button> </a>
        <a href="forestry.php"> <button><img src="./img/agforest.jpg" alt=""><p>Agro-Foresting</p></button> </a>
    ...
    <footer>
      <div class="foot" style="padding-top:10px;">
        <p style="color:#ddd; font-size:18px; text-transform:lowercase;">DigitalFarmKenya PORTFOLIO | AN AGRICULTURAL INFORMATION HUB <br> CONTACT US THE BELOW PLATFORM <br> COPYRIGHT &copyright 2024 </p>
