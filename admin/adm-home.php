...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Admin Home Page | DigitalFarmKenya</title>
  </head>
      ...
      <div class="linker">
        ...
        <div class="linker-btn">
          <center><a href="adm-adm.php">
            <img src="../img/vetenary.jpg" alt="" style="width:80px; height:80px;"><br>
            <?php
        ...
        <div class="linker-btn">
          <center><a href="adm-user.php">
            <img src="../img/useradm.jpeg" alt="" style="width:80px; height:80px;"><br>
            <?php
        ...
        <div class="linker-btn">
          <center><a href="adm-anm.php">
            <img src="../img/aniadm.jpeg" alt="" style="width:80px; height:80px;"><br>
            <?php
        ...
        <div class="linker-btn">
          <center><a href="adm-plt.php">
            <img src="../img/plantsadm.jpeg" alt="" style="width:80px; height:80px;"><br>
            <?php
        ...
        <div class="linker-btn">
          <center><a href="adm-meds.php">
            <img src="../img/medsadm.jpeg" alt="" style="width:80px; height:80px;"><br>
            <?php
        ...
        <div class="linker-btn">
          <center><a href="adm-agrovet.php">
            <img src="../img/prodadm.jpeg" alt="" style="width:80px; height:80px;"><br>
            <?php
