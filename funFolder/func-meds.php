<?php
  ...
  function get_total(){
    include('dbcon.php');
    $result = mysqli_query($con, "select * from meds ORDER BY date DESC");
  ...
  function get_comments(){
    ...
    foreach ($result as $item) {
      ...
      echo '<div class="comment" id="'.$par_code.'">'
          ...
          $child_result = mysqli_query($con, "select * from medreply WHERE par_code = '$par_code' ORDER BY date DESC");
