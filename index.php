...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Welcome Page | DigitalFarm Kenya</title>
  </head>
  <body>
    <header>
      <div class="logo">
...
<footer>
  <div class="foot" style="padding-top:10px;">
    <p style="color:#ddd; font-size:18px; text-transform:lowercase;">DigitalFarmKenya PORTFOLIO | AN AGRICULTURAL INFORMATION HUB <br> CONTACT US THE BELOW PLATFORM <br> COPYRIGHT &copy2024 </p>
