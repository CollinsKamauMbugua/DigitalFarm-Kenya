...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Meds page | DigitalFarm Kenya</title>
  </head>
  <body>
    <header>
      <div class="logo">
    ...
    <div class="br-modal">
      <div class="breadcramps">
        ...
        <a href="medipost.php">Medicinal Section</a>
        <a href="#" class="active">Medicinal Search Results</a>
      </div>
    </div><br><br>
...
if (isset($_POST['msearch'])) {
  ...
  $search_query = mysqli_query($con, "SELECT * FROM meds WHERE title LIKE '%$seach_field%' OR author LIKE '%$seach_field%' OR description LIKE '%$seach_field%' ");
